...
$.fn.editInPlace.defaults = {
	...
	bg_over:			"#8BB9E7", // string: background color of hover of unactivated editor
	bg_out:				"white", // string: background color on restore from hover
	hover_class:		"",  // string: class added to root element during hover. Will override bg_over and bg_out
	show_buttons:		false, // boolean: will show the buttons: cancel or save; will automatically cancel out the onBlur functionality
	save_button:		'<button class="inplace_save">Sauver</button>', // string: image button tag to use as “Save” button
	cancel_button:		'<button class="inplace_cancel">Annuler</button>', // string: image button tag to use as “Cancel” button
	...
	default_text:		"(Cliquez pour ajouter du texte)", // string: text to show up if the element that has this functionality is empty
	...
	select_text:		"Choisissez une nouvelle valeur", // string: default text to show up in select box
	select_options:		"", // string or array: Used if field_type is set to 'select'. Can be comma delimited list of options 'textandValue,text:value', Array of options ['textAndValue', 'text:value'] or array of arrays ['textAndValue', ['text', 'value']]. The last form is especially usefull if your labels or values contain colons)
	text_size:			null, // integer: set cols attribute of text input, if field_type is set to text. Use CSS if possible though
	
	// Specifying callback_skip_dom_reset will disable all saving_* options
	saving_text:		"sauvegarde...", // string: text to be used when server is saving information. Example "Saving..."
	saving_image:		"/ressources/img/img_html/loader2.gif", // string: uses saving text specify an image location instead of text while server is saving
